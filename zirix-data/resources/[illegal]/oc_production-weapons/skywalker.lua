			...
			if item == v.item then
                                    ...
                                    if vRP.getInventoryItemAmount(user_id,"gatilho") >= 1 then
                                        if vRP.tryGetInventoryItem(user_id,"corpo-ak47",1) and vRP.tryGetInventoryItem(user_id,"placa-metal",10) and vRP.tryGetInventoryItem(user_id,"molas",3) and vRP.tryGetInventoryItem(user_id,"gatilho",1) then
                                            ...
                                            SetTimeout(10000,function()
                                                ...
                                                TriggerClientEvent("Notify",source,"sucesso","Montou uma <b>AK47</b>.")
                                            end)
                                        end
                                    else
                                        TriggerClientEvent("Notify",source,"negado","Não tem <b>gatilho</b> na mochila.")
                                    end
                                else
                                    TriggerClientEvent("Notify",source,"negado","Precisa de <b>3x pacotes de mola</b>.")
                                end
                            else
                                TriggerClientEvent("Notify",source,"negado","Precisa de <b>10x placas de metal</b>.")
                            end
                        else
                            TriggerClientEvent("Notify",source,"negado","Não tem <b>corpo de AK-47</b> na mochila.")
                        end
					else
                        ...
                        if vRP.getInventoryItemAmount(user_id,"corpo-aks74u") >= 1 then
                            if vRP.getInventoryItemAmount(user_id,"placa-metal") >= 6 then
                                if vRP.getInventoryItemAmount(user_id,"molas") >= 2 then
                                    if vRP.getInventoryItemAmount(user_id,"gatilho") >= 1 then
                                        if vRP.tryGetInventoryItem(user_id,"corpo-aks74u",1) and vRP.tryGetInventoryItem(user_id,"placa-metal",6) and vRP.tryGetInventoryItem(user_id,"molas",2) and vRP.tryGetInventoryItem(user_id,"gatilho",1) then
                                            ...
                                            SetTimeout(10000,function()
                                                ...
                                                TriggerClientEvent("Notify",source,"sucesso","Montou uma <b>AKS-74U</b>.")
                                            end)
                                        end
                                    else
                                        TriggerClientEvent("Notify",source,"negado","Não tem <b>gatilho</b> na mochila.")
                                    ...
                                    TriggerClientEvent("Notify",source,"negado","Precisa de <b>2x pacotes de mola</b>.")
                                end
                            else
                                TriggerClientEvent("Notify",source,"negado","Precisa de <b>6x placas de metal</b>.")
                            end
                        else
                            TriggerClientEvent("Notify",source,"negado","Não tem <b>corpo de AKS-74U</b> na mochila.")
                        end
					else
						TriggerClientEvent("Notify",source,"negado","Espaço insuficiente na mochila.")
                    end
                    ...
                    if vRP.getInventoryWeight(user_id)+vRP.getItemWeight("wbody|WEAPON_MICROSMG") <= vRP.getInventoryMaxWeight(user_id) then
                        if vRP.getInventoryItemAmount(user_id,"corpo-uzi") >= 1 then
                            if vRP.getInventoryItemAmount(user_id,"placa-metal") >= 3 then
                                    ...
                                    if vRP.getInventoryItemAmount(user_id,"gatilho") >= 1 then
                                        if vRP.tryGetInventoryItem(user_id,"corpo-uzi",1) and vRP.tryGetInventoryItem(user_id,"placa-metal",3) and vRP.tryGetInventoryItem(user_id,"molas",2) and vRP.tryGetInventoryItem(user_id,"gatilho",1) then
                                            ...
                                            SetTimeout(10000,function()
                                                ...
                                                TriggerClientEvent("Notify",source,"sucesso","Montou uma <b>UZI</b>.")
                                            end)
                                        end
                                    else
                                        TriggerClientEvent("Notify",source,"negado","Não tem <b>gatilho</b> na mochila.")
                                ...
                                TriggerClientEvent("Notify",source,"negado","Precisa de <b>3x placas de metal</b>.")
                            end
                        else
                            TriggerClientEvent("Notify",source,"negado","Não tem <b>corpo de UZI</b> na mochila.")
                        end
					else
						TriggerClientEvent("Notify",source,"negado","Espaço insuficiente na mochila.")
                    end
                elseif item == "magnum44" then
                    if vRP.getInventoryWeight(user_id)+vRP.getItemWeight("wbody|WEAPON_REVOLVER_MK2") <= vRP.getInventoryMaxWeight(user_id) then
                        if vRP.getInventoryItemAmount(user_id,"corpo-magnum44") >= 1 then
                            if vRP.getInventoryItemAmount(user_id,"placa-metal") >= 1 then
                                if vRP.getInventoryItemAmount(user_id,"gatilho") >= 1 then
                                    if vRP.tryGetInventoryItem(user_id,"corpo-magnum44",1) and vRP.tryGetInventoryItem(user_id,"placa-metal",1) and vRP.tryGetInventoryItem(user_id,"gatilho",1) then
                                        TriggerClientEvent("kelelaLindo",source)
                                        ...
                                        SetTimeout(10000,function()
                                            ...
                                            TriggerClientEvent("Notify",source,"sucesso","Montou um <b>Revolver Magnum 44</b>.")
                                        end)
                                    end
                                else
                                    TriggerClientEvent("Notify",source,"negado","Não tem <b>gatilho</b> na mochila.")
                                ...
                                TriggerClientEvent("Notify",source,"negado","Não tem <b>placa de metal</b> na mochila.")
                            end
                        else
                            TriggerClientEvent("Notify",source,"negado","Não tem <b>corpo de Magnum 44</b> na mochila.")
                        end
					else
						TriggerClientEvent("Notify",source,"negado","Espaço insuficiente na mochila.")
                    end
                                ...
                                if vRP.getInventoryItemAmount(user_id,"molas") >= 1 then
                                    if vRP.tryGetInventoryItem(user_id,"corpo-glock",1) and vRP.tryGetInventoryItem(user_id,"placa-metal",1) and vRP.tryGetInventoryItem(user_id,"molas",1) then
                                        ...
                                        SetTimeout(10000,function()
                                            ...
                                            TriggerClientEvent("Notify",source,"sucesso","Montou uma <b>Glock</b>.")
                                        end)
                                    end
                                else
                                    TriggerClientEvent("Notify",source,"negado","Não tem <b>pacote de molas</b> na mochila.")
                                end
                            else
                                TriggerClientEvent("Notify",source,"negado","Não tem <b>placa de metal</b> na mochila.")
                            end
                        else
                            TriggerClientEvent("Notify",source,"negado","Não tem <b>corpo de Glock</b> na mochila.")
                        end
					else
						TriggerClientEvent("Notify",source,"negado","Espaço insuficiente na mochila.")
                    end 
