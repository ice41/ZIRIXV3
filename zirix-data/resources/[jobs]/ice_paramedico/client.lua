...
emP = Tunnel.getInterface("ice_paramedico")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = nil
...
local CoordenadaX = 319.73
local CoordenadaY = -564.39
local CoordenadaZ = 28.86
...
-----------------------------------------------------------------------------------------------------------------------------------------
local locs = {
	[1] = { ['x'] = 151.30, ['y'] = -1028.63, ['z'] = 28.84, ['xp'] = 152.45, ['yp'] = -1041.24, ['zp'] = 29.37, ['h'] = 336.05 },
	[2] = { ['x'] = 423.84, ['y'] = -959.30, ['z'] = 28.81, ['xp'] = 421.29, ['yp'] = -973.16, ['zp'] = 30.33, ['h'] = 268.87 },
	...
	[12] = { ['x'] = 916.74, ['y'] = -170.63, ['z'] = 74.46, ['xp'] = 911.15, ['yp'] = -157.44, ['zp'] = 74.31, ['h'] = 155.41 },
	...
	while true do
		...
		if not emservico then
			...
			if distance <= 30.0 then
				...
				drawTxt("PRESSIONE  ~r~E~w~  PARA INICIAR TRANSPORTES",4,0.5,0.91,0.50,255,255,255,180)
